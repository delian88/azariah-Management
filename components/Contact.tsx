      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="reveal from-left">
            <h2 className="text-amg-gold font-bold tracking-wide uppercase text-sm mb-2">Get In Touch</h2>
            ...
            <div className="space-y-8">
              <div className="flex items-start group">
                <div className="flex-shrink-0 mt-1 p-3 bg-amg-blue/5 rounded-lg group-hover:bg-amg-gold/10 transition-colors">
                   <svg className="h-6 w-6 text-amg-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="reveal from-right delay-200 bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full flex justify-center py-4 px-4 border border-transparent rounded-lg shadow-lg text-sm font-bold uppercase tracking-wider text-white bg-amg-blue hover:bg-amg-gold hover:text-amg-blue focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amg-blue transition-all transform hover:-translate-y-1"
              >
                Send Message
              </button>
            </form>
