      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24 mb-20">
            ...
            <div className="flex space-x-5">
              {['facebook', 'twitter', 'linkedin', 'instagram'].map(platform => (
                <a 
                  key={platform} 
                  href="#" 
                  className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-amg-green hover:border-amg-green transition-all duration-300 group"
                  aria-label={platform}
                >
          ...
          <div className="md:col-span-3">
            <h4 className="text-lg font-black mb-8 text-white uppercase tracking-widest font-heading border-l-4 border-amg-green pl-4">Navigation</h4>
          ...
          <div className="md:col-span-4">
            <h4 className="text-lg font-black mb-8 text-white uppercase tracking-widest font-heading border-l-4 border-amg-green pl-4">Headquarters</h4>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="text-amg-green mt-1">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed">{COMPANY_INFO.address}</p>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <p className="text-gray-400 text-sm font-bold tracking-wider">{COMPANY_INFO.phone}</p>
              </div>
            </div>
            
            <div className="mt-12">
               <p className="text-xs text-gray-500 font-bold uppercase tracking-[0.3em] mb-4">Newsletter</p>
               <div className="flex">
                  <input type="email" placeholder="Email Address" className="bg-white/5 border border-white/10 rounded-l-lg px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-amg-green w-full" />
                  <button className="bg-amg-green text-white px-6 py-3 rounded-r-lg font-bold hover:bg-green-600 transition-colors uppercase text-xs">Join</button>
               </div>
            </div>
          </div>
        </div>
        
        <div className="border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center text-gray-500 text-xs font-bold uppercase tracking-widest gap-6">
          <p>&copy; {new Date().getFullYear()} {COMPANY_INFO.name}. Strategic Excellence Integrated.</p>
