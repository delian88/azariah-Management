    ...
    <section id="services" className="py-24 md:py-32 bg-gray-50 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20 reveal from-bottom">
          <h2 className="text-amg-green font-bold tracking-wide uppercase text-sm mb-3">Our Expertise</h2>
          <h3 className="text-4xl md:text-5xl font-extrabold text-amg-blue font-heading mb-6">
            Comprehensive Solutions
          </h3>
          <div className="w-24 h-1.5 bg-gradient-to-r from-amg-green to-transparent mx-auto rounded-full mb-6"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, index) => (
            ...
            >
              ...
              <h4 className="text-2xl font-bold text-amg-blue mb-4 font-heading group-hover:text-amg-green transition-colors">{service.title}</h4>
              <p className="text-gray-600 leading-relaxed mb-6 group-hover:text-gray-700">
                {service.description}
              </p>
              <div className="mt-auto pt-4 border-t border-gray-50">
                <a href="#contact" className="inline-flex items-center text-sm font-bold text-amg-blue group-hover:text-amg-green transition-colors">
                  Learn More 
