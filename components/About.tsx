...
const About: React.FC = () => {
  return (
    <section id="about" className="py-24 md:py-32 bg-white relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-amg-gold/10 blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
          ...
          <div className="relative mb-16 lg:mb-0 reveal from-left">
            <div className="absolute top-0 left-0 w-full h-full border-2 border-amg-gold rounded-2xl transform translate-x-4 translate-y-4 transition-transform duration-500 hover:translate-x-6 hover:translate-y-6"></div>
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-10 -right-4 md:-right-10 bg-white p-8 rounded-xl shadow-2xl hidden md:block max-w-xs animate-float border-l-4 border-amg-gold">
          ...
          <div className="reveal from-right delay-200">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-amg-blue font-heading mb-8 leading-tight">
              A Partner You Can <br/><span className="text-amg-gold relative inline-block">
                Trust & Rely On
                <svg className="absolute w-full h-2 bottom-0 left-0 text-amg-gold/30 -z-10" viewBox="0 0 100 10" preserveAspectRatio="none">
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-gray-100 pt-8">
              <div className="group cursor-default">
                <span className="block text-4xl font-extrabold text-amg-blue mb-1 group-hover:text-amg-gold transition-colors duration-300">10+</span>
              ...
              <div className="group cursor-default">
                <span className="block text-4xl font-extrabold text-amg-blue mb-1 group-hover:text-amg-gold transition-colors duration-300">100%</span>
            ...
            <div className="mt-10">
              <a href="#services" className="inline-flex items-center text-amg-blue font-bold border-b-2 border-amg-gold hover:text-amg-gold hover:border-amg-blue transition-all pb-1 group">
