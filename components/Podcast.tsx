...
const Podcast: React.FC = () => {
  return (
    <section id="podcast" className="py-32 bg-white scroll-mt-24 relative overflow-hidden">
      {/* Decor */}
      <div className="absolute left-0 top-1/4 w-64 h-64 bg-green-50 rounded-full blur-3xl -z-10"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 reveal from-bottom">
          <div className="inline-flex items-center justify-center p-4 bg-green-50 text-amg-green rounded-full mb-6 animate-pulse-slow">
             <Icons.Mic />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="reveal from-left bg-gradient-to-br from-amg-dark to-amg-blue rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden group hover:shadow-[0_20px_50px_rgba(15,44,89,0.3)] transition-shadow duration-500">
            <div className="absolute top-0 right-0 -mt-20 -mr-20 w-64 h-64 bg-amg-green rounded-full opacity-10 blur-3xl group-hover:opacity-20 transition-opacity duration-700"></div>
            
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                 <span className="bg-amg-green/90 backdrop-blur-sm text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider inline-block">Latest Episode</span>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button className="flex items-center space-x-3 bg-white text-amg-blue px-8 py-3 rounded-full font-bold hover:bg-amg-green hover:text-white transition-colors transform hover:-translate-y-0.5 shadow-lg">
          ...
          <div className="space-y-6">
            {[1, 2, 3].map((item, index) => (
              ...
              >
                <div className="w-16 h-16 bg-amg-blue/5 rounded-xl flex-shrink-0 flex items-center justify-center text-amg-blue mr-5 group-hover:bg-amg-blue group-hover:text-white transition-all duration-300 shadow-sm relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-amg-green transform scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom duration-300"></div>
                </div>
                <div className="flex-1">
                  <h4 className="font-bold text-amg-blue text-lg mb-1 group-hover:text-amg-green transition-colors">
                ...
                <div className="ml-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0 text-amg-green">
            ...
            <div className="text-center pt-8 reveal from-bottom delay-300">
              <a href="#" className="inline-flex items-center text-amg-blue font-bold hover:text-amg-green transition-colors group">
                View All Episodes 
